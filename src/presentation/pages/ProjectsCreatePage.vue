...
<template>
  <PageWidth class="projects-create-page">
    <VText tag="h1" class="projects-create-page__title" size="medium">Создание проекта</VText>
    <ProjectForm v-model="formData" submit-text="Создать" @submit="createProject" />
  </PageWidth>
</template>
